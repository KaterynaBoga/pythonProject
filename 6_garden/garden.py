...
class Vegetables:
    ...
    states = {0: "None", 1: "Flowering", 2: "Green", 3: "Red", 4: "Wormy"}
...
class TomatoBush:
    ...
    def insects_attack(self):
        for tomato in self.tomatoes:
            if tomato.states == 3 or tomato.states == 2:
                tomato.states = 4
...
class Gardener:
    ...
    def check_states(self):
        return all([plant.all_are_ripe() for plant in self.plants])
